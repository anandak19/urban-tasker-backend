export const USER_ERROR_MESSAGES = {
  PERSONAL_DATA_UPDATE_ERROR: 'Faild to update personal data',
  PASSWORD_UPDATE_ERROR: 'Faild to update password',
  HOME_ADDRESS_UPDATE_ERROR: 'Faild to update home address',
};
